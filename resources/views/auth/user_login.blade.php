              ...
              <div class="col-lg-12">
                ...
                <div class="mb-3 d-flex" style="gap: 15px;">
                  ...
                  <div class="input-container">
                    <x-text-input class="form-control ph-no" id="exampleFormControlInput1" type="number" name="username" :value="old('username')" placeholder="9744448548252" required autofocus />
