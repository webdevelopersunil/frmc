...
<form method="post" action="{{ route('fco.user-profile.update') }}" id="formSubmitProfileUpdate" class="mt-6 space-y-6">
    @csrf
    @method('post')
    ...
    <div class="row padding-30px">
        ...
        <div class="col-lg-4">
            <div class="mb-3">
                ...
                <!-- <div class="input-container input-container2"> -->
                    <input type="text" class="form-control" name="state" id="exampleFormControlInput1" value="{{old('state', $user->state)}}" placeholder="Haryana" >
                <!-- </div> -->
