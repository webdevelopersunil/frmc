...
<div class="row padding-15px" style="background: #fff;margin: 0 20px;">
    ...
    @include('filters.complain', ['route' => 'fco.complaints'])
    <!-- File Section Start Here 'message-block' -->
        ...
        <table class="table table-striped complainant-table">
            ...
            <tbody>
                ...
                @foreach($lists as $index => $list)
                    <tr onclick="window.location.href='{{ route('fco.complaint.view', $list->id) }}'" 
                        ...
                        <td>
                            @if( isset($list->preliminaryReport->id) )
                                <a href="{{ route('preview.file',$list->preliminaryReport->id) }}" target="_blank" class="d-block " style="color:white;" >
                                    View Report
                                </a>
                            @else
                        ...
                        <td style="border-top-right-radius: 11px;border-bottom-right-radius: 11px;">
                            <a  href="{{ route('fco.complaint.view', $list->id) }}">
